...
const stdoutLog = resolve(artifactRoot, "test.stdout.jsonl");
const stderrLog = resolve(artifactRoot, "test.stderr.log");
...
const lines = readFileSync(stdoutLog, "utf-8").split("\n").filter(l => l.trim());
